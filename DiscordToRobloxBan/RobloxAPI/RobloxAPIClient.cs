...
public class RobloxApiClient
{
    ...
    public async Task<TResponse?> SendRequest<TResponse>(IRequest<TResponse> request)
    {
        ...
        {
            using var httpRequest = new HttpRequestMessage(request.HttpMethod, request.RequestPath);
            ...
            {
                throw new HttpRequestException("Exception occurred during a request to Roblox API:", exception);
            }
            ...
            using (httpResponseMessage)
            {
                if (!httpResponseMessage.IsSuccessStatusCode)
                {
                    ...
                    throw new TimeoutException("Request timed out: " + httpResponseMessage.StatusCode + " " +
